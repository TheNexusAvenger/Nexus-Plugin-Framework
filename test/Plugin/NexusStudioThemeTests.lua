...
NexusUnitTesting:RegisterUnitTest("Constructors",function(UnitTest)
	...
	local CuT1 = NexusStudioTheme.new(Enum.UITheme.Dark)
	UnitTest:AssertEquals(CuT1.ClassName,"NexusStudioTheme","Class name is incorrect.")
	UnitTest:AssertEquals(CuT1.Name,"Dark","Name is incorrect.")
	UnitTest:AssertEquals(tostring(CuT1),"Dark","Name is incorrect.")
	
	--Test the cahce constructor.
	local CuT2,CuT3 = NexusStudioTheme.FromThemeEnum(Enum.UITheme.Light),NexusStudioTheme.FromThemeEnum(Enum.UITheme.Light)
...
NexusUnitTesting:RegisterUnitTest("GetColor",function(UnitTest)
	...
	local CuT = NexusStudioTheme.new(Enum.UITheme.Light)
	...
	UnitTest:AssertClose(CuT:GetColor("DialogMainButton","Disabled"),Color3.new(0.6,0.854902,1),0.001,"Colors aren't close.")
end)
